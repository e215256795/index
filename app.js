...
//2:配置第三方模块
 ...
 server.get('/reg',function(req,res){
  ...
  //执行SQL语句
  pool.query('INSERT INTO nm_login SET ?',[obj],function(err,result){
    if(err) throw err;
	console.log(result);
	//判断是否注册成功
...
server.get("/details",(req,res)=>{
  ...
  if(lid!==undefined){
    var sql1=`select * from nm_index where id=?`;
